...
function Group_Page() {
  ...
  return (
    <div className="Group_Page">
      ...
      {error && <p>Error: {error}</p>}
      <div className="button-container">
         <button className="button" onClick={handleParticipantsClick}>View Participants</button><br />
       </div>
       <p> <span className="head" margin-left="1rem">Add an Expense (choose type of expense) : </span></p>
      <div className="button-container">
        <button className="button" onClick={handleUniformSplitClick}>Uniform Split</button>
      </div>
      <div className="button-container">
        <button className="button" onClick={handleNonUniformSplitClick}>Non-Uniform Split</button>
      </div>
      <div className="button-container">
        <button className="button" onClick={handleLogoutClick}>Log out</button>
      </div>
